                ...
                <div class="card wdt-changelog-card">
                    ...
                    <div class="card-body card-padding">
                        ...
                        <div class="alert alert-info m-b-0" role="alert">
                            ...
                            <ul>
                                <li><strong>Feature:</strong> Alignment settings for column cells – choose to align to the left, center, or right.</li>
                                <li>Compatibility with WordPress 6.2.2 approved</li>
